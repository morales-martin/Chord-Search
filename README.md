...
<h3 align="center">Chord Search</h3>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/morales-martin/chord-search"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/morales-martin/chord-search">View Demo</a>
    ·
    <a href="https://github.com/morales-martin/chord-search/issues">Report Bug</a>
    ·
    <a href="https://github.com/morales-martin/chord-search/issues">Request Feature</a>
  </p>
</div>
...
This web application is a guitar chord searching platform that displays a grid of guitar chords related to a search query entered. All guitar chord diagrams are drawn using the HTML canvas feature. Search results are queried from a third-party API and MongoDB database. Additional features include night mode toggle and adding custom guitar chords.

Searching<br />
![Search Functionality GIF](https://media.giphy.com/media/fYlCVziCE6r5U1OtwS/giphy.gif)

Dark Mode<br />
![Dark Mode Functionality GIF](https://media.giphy.com/media/ExvbIAjBrpbvnCPk7U/giphy.gif)
